...
const WEBBENCH = {
  ...
  webRows: [
    ...
    { model: "Gemini 3.7 Flash", thinking: "low", harness: "Antigravity", score: 97.7, time: 26.0, cost: 0.117, outTok: 1810, steps: 15 },
    { model: "Gemini 3.7 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 44.6, cost: 0.236, outTok: 7028, steps: 22 },
    { model: "Gemini 3.7 Flash", thinking: "high", harness: "Antigravity", score: 97.7, time: 34.6, cost: 0.175, outTok: 5581, steps: 20 },
    { model: "Gemini 3.8 Flash", thinking: "low", harness: "Antigravity", score: 100.0, time: 46.5, cost: 0.153, outTok: 2345, steps: 21 },
    { model: "Gemini 3.8 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 57.8, cost: 0.192, outTok: 7121, steps: 22 },
    { model: "GPT-5.6 Luna", thinking: "low", harness: "Codex CLI", score: 83.7, time: 28.7, cost: 0.014, outTok: 1383, steps: 10 },
    { model: "GPT-5.6 Luna", thinking: "medium", harness: "Codex CLI", score: 90.7, time: 45.3, cost: 0.016, outTok: 1762, steps: 13 },
    { model: "GPT-5.6 Luna", thinking: "high", harness: "Codex CLI", score: 86.4, time: 48.6, cost: 0.022, outTok: 2883, steps: 16 },
    { model: "GPT-5.6 Luna", thinking: "xhigh", harness: "Codex CLI", score: 95.5, time: 65.5, cost: 0.023, outTok: 3355, steps: 15 },
    { model: "GPT-5.6 Luna", thinking: "max", harness: "Codex CLI", score: 93.0, time: 100.3, cost: 0.029, outTok: 4242, steps: 17 },
    { model: "Muse Spark 1.3", thinking: "low", harness: "Muse Code", score: 97.7, time: 26.2, cost: 0.151, outTok: 2356, steps: 13 },
    { model: "Muse Spark 1.3", thinking: "medium", harness: "Muse Code", score: 100.0, time: 30.7, cost: 0.154, outTok: 2902, steps: 14 },
    { model: "Muse Spark 1.3", thinking: "high", harness: "Muse Code", score: 97.7, time: 28.6, cost: 0.162, outTok: 2967, steps: 12 },
    { model: "Muse Spark 1.3", thinking: "xhigh", harness: "Muse Code", score: 100.0, time: 43.4, cost: 0.154, outTok: 2974, steps: 11 },
    { model: "Muse Spark 1.3", thinking: "ultra", harness: "Muse Code", score: 100.0, time: 44.9, cost: 0.163, outTok: 3192, steps: 12 },
    { model: "Muse Spark 1.2", thinking: "low", harness: "Muse Code", score: 97.7, time: 39.5, cost: 0.156, outTok: 3043, steps: 14 },
    { model: "Muse Spark 1.2", thinking: "medium", harness: "Muse Code", score: 90.9, time: 55.1, cost: 0.215, outTok: 4211, steps: 20 },
    { model: "Muse Spark 1.2", thinking: "high", harness: "Muse Code", score: 100.0, time: 65.8, cost: 0.222, outTok: 4953, steps: 17 },
    { model: "Muse Spark 1.2", thinking: "xhigh", harness: "Muse Code", score: 100.0, time: 54.1, cost: 0.254, outTok: 6549, steps: 21 },
    { model: "Muse Spark 1.2", thinking: "ultra", harness: "Muse Code", score: 100.0, time: 70.6, cost: 0.28, outTok: 6341, steps: 24 },
    { model: "Sonnet 5", thinking: "low", harness: "Claude Code", score: 97.7, time: 21.0, cost: 0.313, outTok: 1376, steps: 7 },
    ...
    { model: "Sonnet 5", thinking: "max", harness: "Claude Code", score: 95.5, time: 59.5, cost: 0.594, outTok: 5063, steps: 11 },
    { model: "Opus 5", thinking: "low", harness: "Claude Code", score: 100.0, time: 30.9, cost: 0.403, outTok: 1726, steps: 11 },
    ...
    { model: "Opus 5", thinking: "xhigh", harness: "Claude Code", score: 97.7, time: 67.2, cost: 0.685, outTok: 4233, steps: 19 },
    { model: "Opus 5", thinking: "max", harness: "Claude Code", score: 97.7, time: 94.6, cost: 0.842, outTok: 5805, steps: 23 },
  ],
  tableCaption: [
