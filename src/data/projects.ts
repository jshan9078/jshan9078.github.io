...
const WEBBENCH = {
  ...
  webRows: [
    ...
    { model: "Sonnet 5", thinking: "medium", harness: "Claude Code", time: 19, tokens: 453413, calls: 7, cost: 0.25, ram: 1888 },
    { model: "Haiku 4.5", thinking: "max", harness: "Claude Code", time: 22, tokens: 390817, calls: 8, cost: 0.11, ram: 2275 },
    { model: "Haiku 4.5", thinking: "low", harness: "Claude Code", time: 24, tokens: 389984, calls: 8, cost: 0.11, ram: 1960 },
    { model: "Opus 5", thinking: "high", harness: "Claude Code", time: 27, tokens: 295886, calls: 11, cost: 0.51, ram: 1786 },
    { model: "Sonnet 5", thinking: "high", harness: "Claude Code", time: 28, tokens: 403122, calls: 9, cost: 0.26, ram: 2120 },
    { model: "Gemini 3.7 Flash", thinking: "low", harness: "Antigravity", time: 29, tokens: 88919, calls: 11, cost: 0.13, ram: 1862 },
    { model: "Haiku 4.5", thinking: "high", harness: "Claude Code", time: 34, tokens: 580309, calls: 10, cost: 0.16, ram: 2143 },
    { model: "Opus 5", thinking: "medium", harness: "Claude Code", time: 35, tokens: 281997, calls: 11, cost: 0.47, ram: 2027 },
    { model: "Gemini 3.7 Flash", thinking: "medium", harness: "Antigravity", time: 36, tokens: 123788, calls: 17, cost: 0.24, ram: 2090 },
    { model: "Haiku 4.5", thinking: "xhigh", harness: "Claude Code", time: 38, tokens: 440195, calls: 9, cost: 0.13, ram: 2282 },
    { model: "Haiku 4.5", thinking: "medium", harness: "Claude Code", time: 40, tokens: 652401, calls: 12, cost: 0.15, ram: 2215 },
    { model: "Gemini 3.7 Flash", thinking: "high", harness: "Antigravity", time: 46, tokens: 121111, calls: 20, cost: 0.27, ram: 2095 },
    { model: "Opus 5", thinking: "xhigh", harness: "Claude Code", time: 51, tokens: 348341, calls: 21, cost: 0.68, ram: 2135 },
    { model: "Sonnet 5", thinking: "xhigh", harness: "Claude Code", time: 57, tokens: 609492, calls: 10, cost: 0.33, ram: 2214 },
    { model: "Opus 5", thinking: "max", harness: "Claude Code", time: 62, tokens: 528652, calls: 19, cost: 0.87, ram: 1953 },
    { model: "Sonnet 5", thinking: "max", harness: "Claude Code", time: 84, tokens: 741205, calls: 15, cost: 0.48, ram: 2183 },
  ],
  tableCaption: [
    "7 real-site tasks, medians per task.",
    "Every configuration passed all 7 (pass@1); no accuracy axis, only the cost of getting there.",
    "Claude models run via Claude Code; Gemini 3.7 Flash via the Antigravity harness.",
    "Cost / task is computed from measured token usage (input, output, cache reads and writes) at each model's public pricing in effect as of August 2026, including introductory rates.",
  ],
};
