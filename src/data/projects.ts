...
const WEBBENCH_V1: WebBenchVersion = {
  ...
  tableDesc: "",
  webRows: [
    { model: "Haiku 4.5", thinking: "n/a", harness: "Claude Code", score: 69.5, time: 66.2, cost: 0.262, outTok: 4734, steps: 17, passes: 153, tasks: 220, wallTotal: 84.6, reasonTok: 2407 },
    { model: "Gemini 3.7 Flash", thinking: "low", harness: "Antigravity", score: 97.7, time: 47.4, cost: 0.18, outTok: 2738, steps: 23, passes: 43, tasks: 44, wallTotal: 57.8, reasonTok: 8 },
    { model: "Gemini 3.7 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 68.3, cost: 0.312, outTok: 9558, steps: 31, passes: 44, tasks: 44, wallTotal: 85.7, reasonTok: 5733 },
    { model: "Gemini 3.7 Flash", thinking: "high", harness: "Antigravity", score: 97.7, time: 50.4, cost: 0.235, outTok: 7625, steps: 26, passes: 43, tasks: 44, wallTotal: 64.5, reasonTok: 4304 },
    { model: "Gemini 3.8 Flash", thinking: "low", harness: "Antigravity", score: 100.0, time: 51.1, cost: 0.179, outTok: 2911, steps: 24, passes: 44, tasks: 44, wallTotal: 68.0, reasonTok: 0 },
    { model: "Gemini 3.8 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 66.3, cost: 0.236, outTok: 8495, steps: 26, passes: 44, tasks: 44, wallTotal: 86.0, reasonTok: 5103 },
    { model: "Gemini 3.8 Flash", thinking: "high", harness: "Antigravity", score: 95.5, time: 96.0, cost: 0.363, outTok: 12529, steps: 31, passes: 42, tasks: 44, wallTotal: 119.6, reasonTok: 8292 },
    { model: "GPT-5.6 Luna", thinking: "low", harness: "Codex CLI", score: 83.7, time: 83.0, cost: 0.019, outTok: 1720, steps: 15, passes: 36, tasks: 43, wallTotal: 99.1, reasonTok: 539 },
    { model: "GPT-5.6 Luna", thinking: "medium", harness: "Codex CLI", score: 90.7, time: 73.4, cost: 0.021, outTok: 2318, steps: 16, passes: 39, tasks: 43, wallTotal: 91.7, reasonTok: 980 },
    { model: "GPT-5.6 Luna", thinking: "high", harness: "Codex CLI", score: 86.4, time: 259.6, cost: 0.039, outTok: 3783, steps: 24, passes: 38, tasks: 44, wallTotal: 285.2, reasonTok: 1726 },
    { model: "GPT-5.6 Luna", thinking: "xhigh", harness: "Codex CLI", score: 95.5, time: 295.3, cost: 0.041, outTok: 4529, steps: 25, passes: 42, tasks: 44, wallTotal: 325.7, reasonTok: 2380 },
    { model: "GPT-5.6 Luna", thinking: "max", harness: "Codex CLI", score: 93.0, time: 332.8, cost: 0.036, outTok: 4858, steps: 25, passes: 40, tasks: 43, wallTotal: 370.1, reasonTok: 3059 },
    { model: "Muse Spark 1.3", thinking: "low", harness: "Muse Code", score: 97.7, time: 35.3, cost: 0.194, outTok: 2831, steps: 17, passes: 43, tasks: 44, wallTotal: 46.2, reasonTok: 722 },
    { model: "Muse Spark 1.3", thinking: "medium", harness: "Muse Code", score: 100.0, time: 55.6, cost: 0.254, outTok: 4792, steps: 19, passes: 44, tasks: 44, wallTotal: 67.6, reasonTok: 2166 },
    { model: "Muse Spark 1.3", thinking: "high", harness: "Muse Code", score: 97.7, time: 42.5, cost: 0.216, outTok: 3986, steps: 16, passes: 43, tasks: 44, wallTotal: 55.8, reasonTok: 1655 },
    { model: "Muse Spark 1.3", thinking: "xhigh", harness: "Muse Code", score: 100.0, time: 87.7, cost: 0.291, outTok: 5559, steps: 20, passes: 44, tasks: 44, wallTotal: 105.2, reasonTok: 2697 },
    { model: "Muse Spark 1.3", thinking: "ultra", harness: "Muse Code", score: 100.0, time: 123.6, cost: 0.368, outTok: 6030, steps: 22, passes: 44, tasks: 44, wallTotal: 143.3, reasonTok: 2901 },
    { model: "Muse Spark 1.2", thinking: "low", harness: "Muse Code", score: 97.7, time: 48.8, cost: 0.217, outTok: 3805, steps: 19, passes: 43, tasks: 44, wallTotal: 63.6, reasonTok: 1275 },
    { model: "Muse Spark 1.2", thinking: "medium", harness: "Muse Code", score: 90.9, time: 72.9, cost: 0.328, outTok: 5737, steps: 24, passes: 40, tasks: 44, wallTotal: 90.8, reasonTok: 2574 },
    { model: "Muse Spark 1.2", thinking: "high", harness: "Muse Code", score: 100.0, time: 96.9, cost: 0.336, outTok: 6863, steps: 25, passes: 44, tasks: 44, wallTotal: 313.0, reasonTok: 3126 },
    { model: "Muse Spark 1.2", thinking: "xhigh", harness: "Muse Code", score: 100.0, time: 88.6, cost: 0.422, outTok: 9078, steps: 31, passes: 44, tasks: 44, wallTotal: 102.3, reasonTok: 4300 },
    { model: "Muse Spark 1.2", thinking: "ultra", harness: "Muse Code", score: 100.0, time: 74.6, cost: 0.373, outTok: 7751, steps: 27, passes: 44, tasks: 44, wallTotal: 88.6, reasonTok: 3598 },
    { model: "Sonnet 5", thinking: "low", harness: "Claude Code", score: 97.7, time: 48.5, cost: 0.562, outTok: 2751, steps: 18, passes: 43, tasks: 44, wallTotal: 63.6, reasonTok: 859 },
    { model: "Sonnet 5", thinking: "medium", harness: "Claude Code", score: 93.2, time: 44.1, cost: 0.529, outTok: 2765, steps: 14, passes: 41, tasks: 44, wallTotal: 59.8, reasonTok: 909 },
    { model: "Sonnet 5", thinking: "high", harness: "Claude Code", score: 93.2, time: 65.1, cost: 0.684, outTok: 4376, steps: 18, passes: 41, tasks: 44, wallTotal: 81.3, reasonTok: 1885 },
    { model: "Sonnet 5", thinking: "xhigh", harness: "Claude Code", score: 97.7, time: 70.0, cost: 0.769, outTok: 4908, steps: 19, passes: 43, tasks: 44, wallTotal: 89.7, reasonTok: 2080 },
    { model: "Sonnet 5", thinking: "max", harness: "Claude Code", score: 95.5, time: 108.9, cost: 0.881, outTok: 8749, steps: 18, passes: 42, tasks: 44, wallTotal: 143.2, reasonTok: 5537 },
    { model: "Opus 5", thinking: "low", harness: "Claude Code", score: 100.0, time: 48.2, cost: 0.524, outTok: 2415, steps: 19, passes: 44, tasks: 44, wallTotal: 65.4, reasonTok: 476 },
    { model: "Opus 5", thinking: "medium", harness: "Claude Code", score: 97.7, time: 81.9, cost: 0.743, outTok: 4383, steps: 42, passes: 43, tasks: 44, wallTotal: 100.4, reasonTok: 1340 },
    { model: "Opus 5", thinking: "high", harness: "Claude Code", score: 100.0, time: 86.3, cost: 0.814, outTok: 5231, steps: 30, passes: 44, tasks: 44, wallTotal: 107.6, reasonTok: 1775 },
    { model: "Opus 5", thinking: "xhigh", harness: "Claude Code", score: 97.7, time: 85.5, cost: 0.808, outTok: 5394, steps: 33, passes: 43, tasks: 44, wallTotal: 107.9, reasonTok: 1729 },
    { model: "Opus 5", thinking: "max", harness: "Claude Code", score: 97.7, time: 154.3, cost: 1.131, outTok: 10218, steps: 36, passes: 43, tasks: 44, wallTotal: 183.6, reasonTok: 4929 },
  ],
  tableCaption: [
    "44 tasks built around real-world user interactions on live sites (Amazon, eBay, Google Flights, OpenStreetMap, YouTube, Gmail, Spotify, and more), from multi-hop reads to signed-in account actions and canvas work; time (browser-active seconds), cost, tokens, and steps are per-task means.",
