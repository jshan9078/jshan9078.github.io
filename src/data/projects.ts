...
const WEBBENCH = {
  tableTitle: "WebBench",
  tableDesc:
    "45 tasks built around real-world user interactions on live sites (Amazon, eBay, Google Flights, OpenStreetMap, YouTube, Gmail, Spotify, and more), from multi-hop reads to signed-in account actions and canvas work. Each configuration gets only [browser-automation-cli](/projects/browser-cli) and a [skill](https://github.com/jshan9078/browser-automation-cli/blob/main/SKILL.md) explaining how to use it; every run is judged from captured evidence at pass@1. [See all tasks](https://github.com/jshan9078/web-bench/tree/main/tasks).",
  webRows: [
    { model: "Haiku 4.5", thinking: "low", harness: "Claude Code", score: 68.9, time: 68.7, cost: 0.281, outTok: 4876, steps: 17.9 },
    { model: "Haiku 4.5", thinking: "medium", harness: "Claude Code", score: 62.2, time: 63.0, cost: 0.254, outTok: 4460, steps: 16.0 },
    { model: "Haiku 4.5", thinking: "high", harness: "Claude Code", score: 71.1, time: 65.8, cost: 0.268, outTok: 4656, steps: 17.5 },
    { model: "Haiku 4.5", thinking: "xhigh", harness: "Claude Code", score: 66.7, time: 69.5, cost: 0.267, outTok: 4867, steps: 17.3 },
    { model: "Haiku 4.5", thinking: "max", harness: "Claude Code", score: 68.9, time: 67.8, cost: 0.251, outTok: 4526, steps: 15.9 },
    { model: "Gemini 3.7 Flash", thinking: "low", harness: "Antigravity", score: 95.6, time: 49.7, cost: 0.2, outTok: 2904, steps: 23.7 },
    { model: "Gemini 3.7 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 71.4, cost: 0.331, outTok: 9822, steps: 31.4 },
    { model: "Gemini 3.7 Flash", thinking: "high", harness: "Antigravity", score: 97.8, time: 54.3, cost: 0.255, outTok: 8073, steps: 27.0 },
    { model: "Sonnet 5", thinking: "low", harness: "Claude Code", score: 95.6, time: 49.2, cost: 0.572, outTok: 2812, steps: 16.6 },
    { model: "Sonnet 5", thinking: "medium", harness: "Claude Code", score: 91.1, time: 53.0, cost: 0.578, outTok: 3209, steps: 15.5 },
    { model: "Sonnet 5", thinking: "high", harness: "Claude Code", score: 91.1, time: 64.3, cost: 0.699, outTok: 4276, steps: 17.1 },
    { model: "Sonnet 5", thinking: "xhigh", harness: "Claude Code", score: 95.6, time: 67.0, cost: 0.717, outTok: 4947, steps: 16.6 },
    { model: "Sonnet 5", thinking: "max", harness: "Claude Code", score: 91.1, time: 109.9, cost: 0.894, outTok: 8707, steps: 17.4 },
    { model: "Opus 5", thinking: "low", harness: "Claude Code", score: 97.8, time: 62.0, cost: 0.611, outTok: 3116, steps: 25.0 },
    { model: "Opus 5", thinking: "medium", harness: "Claude Code", score: 97.8, time: 80.3, cost: 0.711, outTok: 4102, steps: 26.9 },
    { model: "Opus 5", thinking: "high", harness: "Claude Code", score: 95.6, time: 86.4, cost: 0.818, outTok: 5157, steps: 25.4 },
    { model: "Opus 5", thinking: "xhigh", harness: "Claude Code", score: 93.3, time: 106.0, cost: 0.968, outTok: 6593, steps: 40.4 },
    { model: "Opus 5", thinking: "max", harness: "Claude Code", score: 95.6, time: 122.7, cost: 1.055, outTok: 8169, steps: 31.7 },
  ],
  tableCaption: [
    "45 live-site tasks per configuration, 810 runs total, all averages per task.",
