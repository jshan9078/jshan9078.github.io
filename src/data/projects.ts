...
const WEBBENCH = {
  tableTitle: "WebBench",
  tableDesc:
    "45 tasks built around real-world user interactions on live sites (Amazon, eBay, Google Flights, OpenStreetMap, YouTube, Gmail, Spotify, and more), from multi-hop reads to signed-in account actions and canvas work. Configurations span Claude (Claude Code), Gemini (Antigravity), and GPT-5.6 (Codex CLI). Each configuration gets only [browser-automation-cli](/projects/browser-cli) and a [skill](https://github.com/jshan9078/browser-automation-cli/blob/main/SKILL.md) explaining how to use it; every run is judged from captured evidence at pass@1. [See all tasks](https://github.com/jshan9078/web-bench/tree/main/tasks).",
  webRows: [
    { model: "Haiku 4.5", thinking: "n/a", harness: "Claude Code", score: 68.0, time: 52.7, cost: 0.203, outTok: 4045, steps: 15 },
    { model: "GPT-5.6 Luna", thinking: "low", harness: "Codex CLI", score: 84.1, time: 31.4, cost: 0.014, outTok: 1383, steps: 11 },
    { model: "GPT-5.6 Luna", thinking: "medium", harness: "Codex CLI", score: 88.4, time: 45.3, cost: 0.016, outTok: 1706, steps: 13 },
    { model: "GPT-5.6 Luna", thinking: "high", harness: "Codex CLI", score: 84.1, time: 49.5, cost: 0.022, outTok: 2932, steps: 16 },
    { model: "GPT-5.6 Luna", thinking: "xhigh", harness: "Codex CLI", score: 95.5, time: 66.0, cost: 0.022, outTok: 3343, steps: 16 },
    { model: "GPT-5.6 Luna", thinking: "max", harness: "Codex CLI", score: 93.0, time: 101.1, cost: 0.029, outTok: 4242, steps: 17 },
    { model: "Gemini 3.7 Flash", thinking: "low", harness: "Antigravity", score: 95.6, time: 26.4, cost: 0.118, outTok: 1910, steps: 16 },
    { model: "Gemini 3.7 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 46.4, cost: 0.255, outTok: 11425, steps: 23 },
    { model: "Gemini 3.7 Flash", thinking: "high", harness: "Antigravity", score: 97.8, time: 34.9, cost: 0.188, outTok: 9149, steps: 21 },
    { model: "Sonnet 5", thinking: "low", harness: "Claude Code", score: 97.8, time: 23.5, cost: 0.317, outTok: 1427, steps: 8 },
    { model: "Sonnet 5", thinking: "medium", harness: "Claude Code", score: 93.3, time: 27.5, cost: 0.395, outTok: 1716, steps: 9 },
    { model: "Sonnet 5", thinking: "high", harness: "Claude Code", score: 93.3, time: 39.7, cost: 0.459, outTok: 2583, steps: 11 },
    { model: "Sonnet 5", thinking: "xhigh", harness: "Claude Code", score: 97.8, time: 44.2, cost: 0.553, outTok: 3601, steps: 11 },
    { model: "Sonnet 5", thinking: "max", harness: "Claude Code", score: 95.6, time: 62.1, cost: 0.633, outTok: 5075, steps: 12 },
    { model: "Opus 5", thinking: "low", harness: "Claude Code", score: 97.8, time: 31.4, cost: 0.405, outTok: 1732, steps: 12 },
    { model: "Opus 5", thinking: "medium", harness: "Claude Code", score: 97.8, time: 42.4, cost: 0.528, outTok: 2533, steps: 15 },
    { model: "Opus 5", thinking: "high", harness: "Claude Code", score: 100.0, time: 59.3, cost: 0.598, outTok: 3657, steps: 21 },
    { model: "Opus 5", thinking: "xhigh", harness: "Claude Code", score: 95.6, time: 75.7, cost: 0.688, outTok: 4311, steps: 21 },
    { model: "Opus 5", thinking: "max", harness: "Claude Code", score: 97.8, time: 96.3, cost: 0.843, outTok: 5927, steps: 24 },
  ],
  tableCaption: [
    "45 live-site tasks per configuration, 810 runs total; time, cost, tokens, and steps are per-task medians.",
    "Score is pass@1 judged by a Claude Sonnet judge from captured evidence (screenshots, traces, cart and end-state ground truth); truth is evaluated at capture time on live sites.",
