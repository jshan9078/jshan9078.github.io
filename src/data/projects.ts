...
const WEBBENCH = {
  ...
  webRows: [
    ...
    { model: "Muse Spark 1.2", thinking: "low", harness: "Muse Code", score: 97.7, time: 51.7, cost: 0.156, outTok: 3044, steps: 14 },
    { model: "Muse Spark 1.2", thinking: "medium", harness: "Muse Code", score: 90.9, time: 68.5, cost: 0.215, outTok: 4211, steps: 20 },
    { model: "Muse Spark 1.2", thinking: "high", harness: "Muse Code", score: 97.7, time: 80.2, cost: 0.222, outTok: 4954, steps: 18 },
    { model: "Muse Spark 1.2", thinking: "xhigh", harness: "Muse Code", score: 97.7, time: 64.5, cost: 0.254, outTok: 6549, steps: 22 },
    { model: "Muse Spark 1.2", thinking: "ultra", harness: "Muse Code", score: 100.0, time: 80.2, cost: 0.28, outTok: 6341, steps: 24 },
