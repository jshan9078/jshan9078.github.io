...
const WEBBENCH_V1: WebBenchVersion = {
  ...
  webRows: [
    ...
    { model: "Gemini 3.7 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 44.6, cost: 0.236, outTok: 7028, steps: 22, passes: 44, tasks: 44, wallTotal: 61.8, reasonTok: 4454 },
    { model: "Gemini 3.7 Flash", thinking: "high", harness: "Antigravity", score: 97.7, time: 34.6, cost: 0.175, outTok: 5581, steps: 20, passes: 43, tasks: 44, wallTotal: 48.7, reasonTok: 3453 },
    { model: "Gemini 3.8 Flash", thinking: "low", harness: "Antigravity", score: 100.0, time: 46.5, cost: 0.153, outTok: 2345, steps: 21, passes: 44, tasks: 44, wallTotal: 57.8, reasonTok: 0 },
    { model: "Gemini 3.8 Flash", thinking: "medium", harness: "Antigravity", score: 100.0, time: 57.8, cost: 0.192, outTok: 7121, steps: 22, passes: 44, tasks: 44, wallTotal: 76.2, reasonTok: 4351 },
    { model: "Gemini 3.8 Flash", thinking: "high", harness: "Antigravity", score: 95.5, time: 69.9, cost: 0.221, outTok: 9624, steps: 25, passes: 42, tasks: 44, wallTotal: 92.1, reasonTok: 6909 },
    { model: "GPT-5.6 Luna", thinking: "low", harness: "Codex CLI", score: 83.7, time: 28.7, cost: 0.014, outTok: 1383, steps: 10, passes: 36, tasks: 43, wallTotal: 41.7, reasonTok: 438 },
    { model: "GPT-5.6 Luna", thinking: "medium", harness: "Codex CLI", score: 90.7, time: 45.3, cost: 0.016, outTok: 1762, steps: 13, passes: 39, tasks: 43, wallTotal: 69.0, reasonTok: 710 },
    { model: "GPT-5.6 Luna", thinking: "high", harness: "Codex CLI", score: 86.4, time: 48.6, cost: 0.022, outTok: 2883, steps: 16, passes: 38, tasks: 44, wallTotal: 65.6, reasonTok: 1477 },
    { model: "GPT-5.6 Luna", thinking: "xhigh", harness: "Codex CLI", score: 95.5, time: 65.5, cost: 0.023, outTok: 3355, steps: 15, passes: 42, tasks: 44, wallTotal: 89.9, reasonTok: 1897 },
    { model: "GPT-5.6 Luna", thinking: "max", harness: "Codex CLI", score: 93.0, time: 100.3, cost: 0.029, outTok: 4242, steps: 17, passes: 40, tasks: 43, wallTotal: 133.1, reasonTok: 2515 },
    { model: "Muse Spark 1.3", thinking: "low", harness: "Muse Code", score: 97.7, time: 26.2, cost: 0.151, outTok: 2356, steps: 13, passes: 43, tasks: 44, wallTotal: 37.7, reasonTok: 520 },
    { model: "Muse Spark 1.3", thinking: "medium", harness: "Muse Code", score: 100.0, time: 30.7, cost: 0.154, outTok: 2902, steps: 14, passes: 44, tasks: 44, wallTotal: 40.0, reasonTok: 976 },
    { model: "Muse Spark 1.3", thinking: "high", harness: "Muse Code", score: 97.7, time: 28.6, cost: 0.162, outTok: 2967, steps: 12, passes: 43, tasks: 44, wallTotal: 39.4, reasonTok: 1264 },
    { model: "Muse Spark 1.3", thinking: "xhigh", harness: "Muse Code", score: 100.0, time: 43.4, cost: 0.154, outTok: 2974, steps: 11, passes: 44, tasks: 44, wallTotal: 60.9, reasonTok: 1227 },
    { model: "Muse Spark 1.3", thinking: "ultra", harness: "Muse Code", score: 100.0, time: 44.9, cost: 0.163, outTok: 3192, steps: 12, passes: 44, tasks: 44, wallTotal: 71.4, reasonTok: 1464 },
    { model: "Muse Spark 1.2", thinking: "low", harness: "Muse Code", score: 97.7, time: 39.5, cost: 0.156, outTok: 3043, steps: 14, passes: 43, tasks: 44, wallTotal: 51.7, reasonTok: 1048 },
    { model: "Muse Spark 1.2", thinking: "medium", harness: "Muse Code", score: 90.9, time: 55.1, cost: 0.215, outTok: 4211, steps: 20, passes: 40, tasks: 44, wallTotal: 68.5, reasonTok: 1652 },
    { model: "Muse Spark 1.2", thinking: "high", harness: "Muse Code", score: 100.0, time: 65.8, cost: 0.222, outTok: 4953, steps: 17, passes: 44, tasks: 44, wallTotal: 80.2, reasonTok: 2066 },
    { model: "Muse Spark 1.2", thinking: "xhigh", harness: "Muse Code", score: 100.0, time: 54.1, cost: 0.254, outTok: 6549, steps: 21, passes: 44, tasks: 44, wallTotal: 64.5, reasonTok: 3109 },
    { model: "Muse Spark 1.2", thinking: "ultra", harness: "Muse Code", score: 100.0, time: 70.6, cost: 0.28, outTok: 6341, steps: 24, passes: 44, tasks: 44, wallTotal: 80.2, reasonTok: 2825 },
    { model: "Sonnet 5", thinking: "low", harness: "Claude Code", score: 97.7, time: 21.0, cost: 0.313, outTok: 1376, steps: 7, passes: 43, tasks: 44, wallTotal: 35.7, reasonTok: 0 },
    { model: "Sonnet 5", thinking: "medium", harness: "Claude Code", score: 93.2, time: 27.0, cost: 0.393, outTok: 1697, steps: 8, passes: 41, tasks: 44, wallTotal: 39.4, reasonTok: 0 },
    { model: "Sonnet 5", thinking: "high", harness: "Claude Code", score: 93.2, time: 38.6, cost: 0.454, outTok: 2548, steps: 10, passes: 41, tasks: 44, wallTotal: 51.7, reasonTok: 0 },
    { model: "Sonnet 5", thinking: "xhigh", harness: "Claude Code", score: 97.7, time: 44.0, cost: 0.511, outTok: 3444, steps: 11, passes: 43, tasks: 44, wallTotal: 60.5, reasonTok: 0 },
    { model: "Sonnet 5", thinking: "max", harness: "Claude Code", score: 95.5, time: 59.5, cost: 0.594, outTok: 5063, steps: 11, passes: 42, tasks: 44, wallTotal: 97.5, reasonTok: 0 },
    { model: "Opus 5", thinking: "low", harness: "Claude Code", score: 100.0, time: 30.9, cost: 0.403, outTok: 1726, steps: 11, passes: 44, tasks: 44, wallTotal: 46.5, reasonTok: 0 },
    { model: "Opus 5", thinking: "medium", harness: "Claude Code", score: 97.7, time: 39.0, cost: 0.508, outTok: 2448, steps: 14, passes: 43, tasks: 44, wallTotal: 54.5, reasonTok: 0 },
    { model: "Opus 5", thinking: "high", harness: "Claude Code", score: 100.0, time: 54.9, cost: 0.583, outTok: 3648, steps: 20, passes: 44, tasks: 44, wallTotal: 72.3, reasonTok: 0 },
    { model: "Opus 5", thinking: "xhigh", harness: "Claude Code", score: 97.7, time: 67.2, cost: 0.685, outTok: 4233, steps: 19, passes: 43, tasks: 44, wallTotal: 93.6, reasonTok: 0 },
