...
const WEBBENCH = {
  ...
  webRows: [
    { model: "Haiku 4.5", thinking: "n/a", harness: "Claude Code", score: 67.6, time: 52.3, cost: 0.203, outTok: 3996, steps: 15 },
    ...
    { model: "Sonnet 5", thinking: "low", harness: "Claude Code", score: 95.6, time: 23.5, cost: 0.317, outTok: 1427, steps: 8 },
    { model: "Sonnet 5", thinking: "medium", harness: "Claude Code", score: 91.1, time: 27.5, cost: 0.395, outTok: 1716, steps: 9 },
    { model: "Sonnet 5", thinking: "high", harness: "Claude Code", score: 91.1, time: 39.7, cost: 0.459, outTok: 2583, steps: 11 },
    { model: "Sonnet 5", thinking: "xhigh", harness: "Claude Code", score: 95.6, time: 44.2, cost: 0.553, outTok: 3601, steps: 11 },
    { model: "Sonnet 5", thinking: "max", harness: "Claude Code", score: 91.1, time: 62.1, cost: 0.633, outTok: 5075, steps: 12 },
    ...
    { model: "Opus 5", thinking: "high", harness: "Claude Code", score: 95.6, time: 59.3, cost: 0.598, outTok: 3657, steps: 21 },
    { model: "Opus 5", thinking: "xhigh", harness: "Claude Code", score: 93.3, time: 75.7, cost: 0.688, outTok: 4311, steps: 21 },
    { model: "Opus 5", thinking: "max", harness: "Claude Code", score: 95.6, time: 96.3, cost: 0.843, outTok: 5927, steps: 24 },
  ],
  tableCaption: [
